          ...
          <div className='flex flex-col md:flex-row md:items-center md:justify-between mb-6'>
            <div>
              <h3 className='text-3xl mb-2'>
                {navIcon.firstName} <span className='whitespace-nowrap'>{navIcon.lastName}</span>
              </h3>
            ...
            <FlipCard
              ...
              front={
                <div className='absolute inset-0 bg-card border-2 border-primary/30 rounded-lg p-6 flex flex-col items-center justify-center'>
                  <div
                    className={`w-16 h-16 mb-4 rounded-full bg-gradient-to-br ${attribute.color} flex items-center justify-center`}>
                    <IconWrapper size={32}>{attribute.icon}</IconWrapper>
                  </div>
                  <h4 className='text-xl mb-2 text-center'>{attribute.name}</h4>
              ...
              back={
                <div className='absolute inset-0 bg-card border-2 border-primary/30 rounded-lg p-6 flex flex-col items-center justify-center'>
                  <div
                    className={`w-12 h-12 mb-3 rounded-full bg-gradient-to-br ${attribute.color} flex items-center justify-center`}>
                    <IconWrapper size={24}>{attribute.icon}</IconWrapper>
                  </div>
